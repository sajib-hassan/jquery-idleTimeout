  ...
  $.fn.idleTimeout = function (userRuntimeConfig) {
    ...
    openWarningDialog = function () {
      ...
      var d = $(dialogContent).dialog({
        ...
        close: function() {
          if(currentConfig.dialogCssScopeClassName){
            $('body').removeClass(currentConfig.dialogCssScopeClassName);
          }
        },
        open: function () {
          $(this).closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
          if(currentConfig.dialogCssScopeClassName){
            $('body').addClass(currentConfig.dialogCssScopeClassName);
          }
        }
      });
    ...
    countdownDisplay = function () {
      ...
      remainingTimer = setInterval(function () {
        if (dialogDisplaySeconds < 0) { return;}
    ...
    logoutUser = function () {
      ...
      if(store.get('fireIdleTimerLoggedOutCallback') === true){ return; }

      store.set('fireIdleTimerLoggedOutCallback', true);
    ...
    return this.each(function () {
      ...
      if (store.enabled) {
        ...
        store.set('fireIdleTimerLoggedOutCallback', false);
